...
var player1Name = prompt("Player 1, type your name!")
var player2Name = prompt("Player 2, type your name!")
var whosTurn = 1;
var player1Squares = [];
var player2Squares = [];
var winningCombos = [
...
var markSquare = function(squareClicked){
	...
	if(squareClicked.innerHTML !== '-'){
		...
		squareClicked.innerHTML = "<img src=images/image1.jpg>";
		whosTurn = 2;
		player1Squares.push(squareClicked.id);
		console.log(player1Squares);
		document.getElementById('message').innerHTML = `${player2Name}'s turn to click a square!`;
		checkWin(player1Squares,1);
	}else{
		squareClicked.innerHTML = "<img src=images/image2.jpg>";
		whosTurn = 1;
		player2Squares.push(squareClicked.id);
		document.getElementById('message').innerHTML = `${player1Name}'s turn to click a square!`;
